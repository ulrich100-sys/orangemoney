          ...
          ?>
            ...
            <form action="paiement-traitement.php" method="POST">
              <div class="form-group">
                <label for="exampleInputNom"><strong>Nom/prénom Téléconseiller</strong></label>
              ...
              <div class="form-group">
                <label for="exampleInputAP"><strong>N° AP / N° Devis</strong>(ce numéro doit être unique et correspondant à celui dans l'ERP)</label>
                <input type="text" class="form-control" id="exampleInputAP" aria-describedby="emailHelp" name="exampleInputAP" required <?php 
                        if(isset($_SESSION["exampleInputAP"])){
                          echo 'value="'.$_SESSION["exampleInputAP"].'"';
                      } ?>>
              </div>
              <div class="form-group">
                <label for="exampleInputMontant"><strong>Montant</strong></label>
                <input type="number" class="form-control" id="exampleInputMontant" name="exampleInputMontant" required <?php 
                        if(isset($_SESSION["exampleInputMontant"])){
                          echo 'value="'.$_SESSION["exampleInputMontant"].'"';
                      } ?>>
              </div>
