...
$request = "select * from Orders where method='OrangeMoney' and status!='FAILED' and status!='EXPIRED' and status!='SUCCESSFULL' and DATE_ADD(CURRENT_TIMESTAMP, INTERVAL - 30 MINUTE);";
